...
const char * LIB_PATH_VALUE   = "C:\\MinGW\\msys\\1.0\\home\\Naver\\libimobiledevice-master\\src\\.libs;c:\\mingw\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "c;c:\\mingw\\lib;c;c:\\mingw\\bin;C:\\MinGW\\msys\\1.0\\home\\Naver\\libimobiledevice-master\\src\\.libs;";
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicenotificationproxy - temporary wrapper script for .libs/idevicenotificationproxy.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicenotificationproxy program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libimobiledevice.la c:/mingw/lib/libusbmuxd.la /mingw/lib/libplist.la /mingw/lib/libiconv.la c:/mingw/lib/libplist.la /mingw/lib/libxml2.la c:/mingw/lib/libiconv.la c:/mingw/lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"idevicenotificationproxy.exe:idevicenotificationproxy:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicenotificationproxy.exe:idevicenotificationproxy:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicenotificationproxy.exe:idevicenotificationproxy:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=c:/mingw/lib:c:/mingw/bin:/home/Naver/libimobiledevice-master/src/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/Naver/libimobiledevice-master/src/.libs:/mingw/lib:$PATH\"\n", f);
  fputs ("\n", f);
